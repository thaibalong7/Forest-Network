    ...
    return (
        <div className="container mx-auto flex flex-col lg:flex-row mt-3 text-sm leading-normal">
            ...
            <div className="w-full lg:w-1/4 pl-4 lg:pl-0 pr-6 mt-8 mb-4">
                <h2><div className="text-black font-bold no-underline hover:underline">{props.userProfileReducer.name}</div></h2>
                <div className="mb-4"><a href="#" className="text-grey-darker no-underline hover:underline">@{props.userProfileReducer.name}</a></div>
                ...
                <div className="mb-2"><i className="fa fa-at fa-lg text-grey-darker mr-1"></i><a href="#" className="text-teal no-underline hover:underline">{props.userProfileReducer.email}</a></div>
