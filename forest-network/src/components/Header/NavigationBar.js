...
import {change_flag} from "../../actions/index";

class NavigationBar extends Component {   
    
    onChangeFlag(event){
        console.log(event);
        this.props.change_flag(event);
    }
            ...
            <div className="bg-white">
                <div className="container mx-auto flex flex-col lg:flex-row items-center py-2">
                    <nav className="w-full lg:w-2/5">
                        <Link to="/home" onClick={() => this.onChangeFlag("home")} className={homeStyles}><i className="fa fa-home fa-lg"></i>  Home</Link>
                        ...
                        <Link to="/notifications" onClick={() => this.onChangeFlag("noti")} className={notiStyles}><i className="fa fa-bell fa-lg"></i>  Notifications</Link>
                        <Link to="/me" onClick={() => this.onChangeFlag("me")} className={meStyles}><i className="fa fa-user fa-lg"></i>  Me   </Link>
                    </nav>
                        ...
                        <div className="w-full lg:w-1/1">
                            <ul className="list-reset flex">
                                <li className="text-center py-3 px-2 border-b-2 border-solid border-transparent">
                                    <Link to="/tweet" className="text-grey-darker no-underline hover:no-underline">
                                ...
                                <li className="text-center py-3 px-2 border-b-2 border-solid border-transparent">
                                    <Link to="/following" className="text-grey-darker no-underline hover:no-underline">
                                ...
                                <li className="text-center py-3 px-2 border-b-2 border-solid border-transparent">
                                    <Link to="/follower" className="text-grey-darker no-underline hover:no-underline">
